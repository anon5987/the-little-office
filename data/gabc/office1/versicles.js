/**
 * Office 1 (Ordinary Time) - Versicles
 * Solemn tone (Sundays/Feasts) and Simple tone variants
 */

export default {
  // Vespers Versicle - Solemn tone (Sundays and Feasts)
...
Prop(h)té(h)re(h)a(h) be(h)ne(h)dí(h)xit(h) te(h) De(h)us(h) in(h) ae(h)tér(h)num.(g_ hvGFEfgf.) (::)`,
  ...
  // Vespers Versicle - Simple tone (Other times)
...
Ut(h) di(h)gni(h) ef(h)fi(h)ci(h)a(h)mur(h) pro(h)mis(h)si(h)o(h)ni(h)bus(h) Chri(h)sti.(f.) (::)`,
  ...
  // Lauds Versicle - Solemn tone (Sundays and Feasts)
...
Et(h) be(h)ne(h)di(h)ctus(h) fru(h)ctus(h) ven(h)tris(h) tu(h)i.(g_ hvGFEfgf.) (::)`,
  ...
  // Lauds Versicle - Simple tone (Other times)
