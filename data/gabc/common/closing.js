...
export const gabcDomineExaudi = `initial-style: 1;
%%
...
export const gabcOremus = `initial-style: 1;
%%
(c3)O(h)re(h)mus.(h) (:)
...
export const gabcBenedicamus = `initial-style: 1;
%%
...
export default {
  'domine-exaudi': gabcDomineExaudi,
  'oremus': gabcOremus,
  'benedicamus': gabcBenedicamus
};
